...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ergodox_pretty(
        ...
        KC_NO,      KC_B,       KC_NO,      KC_LGUI,    KC_LALT,    LCTL_T(KC_SPC),LT(2,KC_ENT),    LT(1,KC_ESC),KC_RSFT,   KC_RALT,KC_RGUI,   KC_NO,      KC_SLSH,    KC_NO,
	...
	[2] = LAYOUT_ergodox_pretty(
        ...
        KC_NO,      KC_NO,      KC_NO,      KC_LGUI,    KC_LALT,    KC_NO,      KC_NO,              LT(1,KC_ESC),KC_RSFT,   KC_RALT,KC_RGUI,   KC_NO,      KC_NO,      KC_NO,
        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,                                                              KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
                                                                    KC_NO,      KC_NO,              KC_NO,      KC_NO,
                                                                                KC_NO,              KC_NO,
                                                        KC_NO,     KC_NO,       KC_NO,              KC_NO,      KC_NO,      KC_NO
