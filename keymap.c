...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ergodox_pretty(
        ...
        KC_NO,      KC_B,       KC_NO,      KC_NO,      KC_LALT,    LCTL_T(KC_SPC),LT(2,KC_ENT),           LT(1,KC_ESC),KC_RSFT,   KC_LGUI,    KC_NO,      KC_NO,      KC_SLSH,    KC_NO,
	...
	[1] = LAYOUT_ergodox_pretty(
        ...
        KC_NO,      KC_AT,      KC_NO,      KC_NO,      KC_LALT,    LCTL_T(KC_SPC),LT(2,KC_ENT),    KC_NO,      KC_NO,      KC_LGUI,    KC_NO,      KC_NO,      KC_GRV,     KC_NO,
        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,                                                              KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
                                                                    KC_NO,      KC_NO,              KC_NO,      KC_NO,
                                                                                KC_NO,              KC_NO,
                                                        KC_NO,      KC_NO,      KC_NO,              KC_NO,      KC_NO,      KC_NO
	...
	[2] = LAYOUT_ergodox_pretty(
        KC_NO,      KC_NO,      RALT(KC_Q), RALT(KC_Y), RALT(KC_P), RALT(KC_S), KC_NO,              KC_NO,      KC_BSPC,    KC_BSPC,    KC_ENT,     KC_TAB,     KC_NO,      KC_NO,
        ...
        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_LALT,    KC_NO,      KC_NO,              LT(1,KC_ESC),KC_RSFT,   KC_LGUI,    KC_NO,      KC_NO,      KC_NO,      KC_NO,
        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,                                                              KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
                                                                    KC_NO,      KC_NO,              KC_NO,      KC_NO,
                                                                                KC_NO,              KC_NO,
                                                        KC_NO,     KC_NO,       KC_NO,              KC_NO,      KC_NO,      KC_NO
